...
const productSchema = new mongoose.Schema(
  {
    ...
    price: { type: Number, default: 0, min: [0, "Narx 0 dan kam bo'lishi mumkin emas"] },
    oldPrice: { type: Number, default: 0, min: [0, "Eski narx 0 dan kam bo'lishi mumkin emas"] },
    priceUsd: { type: Number, default: 50, required: true, min: [0, "Narx 0 dan kam bo'lishi mumkin emas"] },
    pachkaPriceUsd: { type: Number, default: 45, min: [0, "Pachka narxi 0 dan kam bo'lishi mumkin emas"] },
    pachkaQty: { type: Number, default: 6, min: 1 },
    unitPriceUsd: { type: Number, default: 0, min: [0, "Dona narxi 0 dan kam bo'lishi mumkin emas"] },
